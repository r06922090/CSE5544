# Usage:
# python dnsmos_local.py -t /users/PAS2301/kibria5/Research/MetricGAN-master/Temp_Data/Train_Noisy -o DNSCh4_Blind.csv
# python dnsmos_local.py -t /users/PAS2301/kibria5/Research/MetricGAN-master/Temp_Data/Test_Noisy -o sample.csv
# Namespace(testset_dir='/users/PAS2301/kibria5/Research/MetricGAN-master/Temp_Data/Test_Noisy', csv_path='sample.csv', personalized_MOS=False)
#
...
def file_dnsmos(testfile, personalized_MOS=False):

    # models = glob.glob(os.path.join(testset_dir, "*"))
    models = [testfile] # Imran Edited
    ...
    for m in tqdm(models):
        ...
        audio_path = os.path.join(testfile, m) # Imran Edited
    ...
    return float(df['P808_MOS'].to_string(index=False)) # Imran Edited


def dnsmos(testset_dir, csv_path = 'Sample.csv', personalized_MOS=False):

    models = glob.glob(os.path.join(testset_dir, "*"))
    
    audio_clips_list = []
    p808_model_path = os.path.join('/users/PAS2301/kibria5/Research/3/MetricGAN-master/DNSMOS/DNSMOS', 'model_v8.onnx')
    ...
    return df['filename'].to_list(), df['P808_MOS'].to_list() # Imran Edited
...
if __name__=="__main__":
    ...
    dnsmos(args.testset_dir, args.csv_path)
